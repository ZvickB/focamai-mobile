...
- The compact Results selected-product hero is settled on Inline through 415 logical pixels. It shows normalized title and price on the left with a larger image on the right, directly on the page background; the temporary comparison toggle and white Card variant were removed.
