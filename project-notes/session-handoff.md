...
- The Results selected-product hero is settled on Inline at all widths, directly on the page background with no separate white card. Through 415 logical pixels it shows normalized title and price on the left with a larger image on the right; wider screens keep the fuller reason/rating content and right-side image. The temporary comparison toggle and white Card variant were removed.
